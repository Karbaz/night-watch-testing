var testCaseUrls = require("../../testing_urls").urls.SEO
...
Object.keys(testCaseUrls).map((value, index) => {
    ...
    let copy_test = Object.assign({
        [`${index+1} TESTING SEO FOR ${testDetails.tag}`]: function (browser) {
            ...
            .verify.attributeEquals("meta[property='og:title']", "content", testDetails.title)
            .verify.attributeEquals("meta[property='og:description']", "content", testDetails.desc)
            .end();
        },
